...
float Protective_current=2000;//mA
int Protective_temp=50;//°
int Protective_voltage=1290;//0.01v
int Protective_voltage_min=600;//0.01v
...
bool first_shoulder=true;
bool first_elbow=true;
